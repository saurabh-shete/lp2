...
def response_weather():
    weather_responses = [
        ...
        "Looks like it's going to rain later. Don't forget your umbrella!",
        "It's quite cold outside. Make sure to bundle up!",
        "The weather forecast predicts snowfall tomorrow. Get ready for a winter wonderland!",
    ]
...
def check_all_messages(message):
    ...
    response(response_jokes(), ['joke', 'funny'], single_response=True)
    response(response_weather(), ['weather'], single_response=True)
